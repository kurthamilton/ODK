...
stateDiagram-v2
    ...
    Registered --> Registered: SignUp [to a group, presented with the invite token]
    Registered --> Registered: SignUp [to a group, not presented with the invite token]
